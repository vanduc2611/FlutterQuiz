...
class RectangleTimerProgressContainer extends StatefulWidget {
  ...
  final Color color;
  RectangleTimerProgressContainer({Key? key, required this.animationController, required this.color}) : super(key: key);

  @override
  _RectangleTimerProgressContainerState createState() => _RectangleTimerProgressContainerState();
}

class _RectangleTimerProgressContainerState extends State<RectangleTimerProgressContainer> {
